...
# print(type(InitialisationDic))
# print(InitialisationDic)

postRequest = "Information about the importance of Iron in food"
postLanguage = "EN"
postCategory = 'Meme'
payload = {'Initialisation': InitialisationDic, 'postRequest': postRequest, 'postLanguage': postLanguage, 'postCategory': postCategory}
