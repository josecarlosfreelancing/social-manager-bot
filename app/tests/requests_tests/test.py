...
InitialisationDicShort = [
    {
        'Concept': "Information about Zinc health benefits",
        'Caption': "Half of the world's population does not consume enough zinc"
    },
    {
        'Concept': "Promoting Puressentiel's stress roller.",
        'Caption': "De-stress yourself in a different way! 12 essential oils with relaxing and soothing properties are combined in Puressentiel."
    }
]
...
text = '1 person and text that says -cE SOIR JE CUISINE. -MOI À 20 HEURES. CHAMAS TACOS'
newtext = translate_text(text, 'EN')

assert text == "1 person and text that says -cE SOIR JE CUISINE. -MOI À 20 HEURES. CHAMAS TACOS"
